...
## Kenney (`sprites/kenney/`, `sounds/kenney/`)

Todos os packs do Kenney aqui usados são distribuídos sob **Creative Commons CC0 1.0 Universal** (domínio público).

> Você pode copiar, modificar, distribuir e usar os assets, inclusive para fins comerciais, sem pedir permissão. **Atribuição não é obrigatória**, mas é apreciada.
...
Obrigado, Kenney! 💛 — https://kenney.nl

## Pixel Frog (`sprites/pixelfrog/`)
